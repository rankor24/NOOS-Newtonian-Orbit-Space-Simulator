...
export const UPGRADES: ShipUpgrade[] = [
  ...
  },
  {
    ...
    description: "Advanced magnetoplasmadynamic engine. Increases continuous thrust to 280,000 N and boosts efficiency (Isp = 4,500s).",
    cost: 8500,
    unlocked: false,
    category: "engine",
    modifier: (ship) => ({ ...ship, engineThrust: 280000, engineIsp: 4500 }),
  },
  {
    id: "engine_ii",
    name: "Helios Fusion Drive Core",
    description: "A catalytic magnetic-confinement fusion torch. Generates a gigantic 1,200,000 N thrust with astronomical efficiency (Isp = 9,500s).",
    cost: 32000,
    unlocked: false,
    category: "engine",
    modifier: (ship) => ({ ...ship, engineThrust: 1200000, engineIsp: 9500 }),
  },
  {
    id: "cargo_i",
